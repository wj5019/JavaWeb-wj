...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="cn.tedu.javaweb.pojo.Book,java.util.ArrayList,cn.tedu.javaweb.pojo.User" %>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    ...
    <div id="demo" style="width:1000px;overflow:hidden;">
        <div id="indemo" style="float: left;width: 200%;">
            ...
            for(int i=0;i<newList.size();i++){
            	Book b=newList.get(i);
            %>
            <div class="detail_1 lf">                    
            <div class="detail_img1">
            <a href="detailBookServlet?isbn=<%=b.getIsbn() %>"><img src="../img/goods/<%=b.getIsbn() %>/detail1big.jpg" border="0"></a>
               </div>
             <p><%=b.getTitle() %></p>
...
<script>
    ...
    $(function () {
        ...
        $("#collect").click(function (){
           	...
           	$.ajax({
                type: "post",
                url: '../page/clickCollectServlet',
                data: "userId=<%=user.getPhone()%>&product=<%=book.getIsbn()%>",//params,
