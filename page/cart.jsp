<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="cn.tedu.javaweb.pojo.CartAndBook"%>
<%@page import="cn.tedu.javaweb.pojo.Cart"%>
<%@page import="cn.tedu.javaweb.pojo.Book"%>
    ...
    <section id="section" >
        ...
        <div id="box" >
            <div id="content_box">
                ...
                <%
                ArrayList<CartAndBook> cabs=(ArrayList<CartAndBook>)request.getAttribute("cabs");
                for(CartAndBook cab:cabs){
                    ...
                    <div class="pudc">
                        ...
                        <span class="des lf">
                         <%=book.getTitle() %>
                            ...
                            <p class="col lf"><span>作者：</span><span class="color_des"><%=book.getAuthor() %> 编  <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des"></p>
...
$(function(){
    ...
    $('.del_d').click(function() {
        ...
        $('.yes').click(function(){
          var url ='deleteCartServlet?itemId='+id;
           window.location.href=url;
        })
    });
});
